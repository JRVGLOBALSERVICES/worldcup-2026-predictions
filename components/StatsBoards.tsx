...
import { STAT_CATEGORIES, type StatRow, type StatsFile } from "@/lib/stats";
...
/**
 * The seven tournament leaderboards + a "Force update" button that recomputes
 * them from ESPN on demand (via /api/stats). SSR renders the committed cron
 * snapshot for SEO/first paint; the button swaps in the as-of-now leaders.
 */
